...
harenhall = cell('harenhall', 0, 1, 1, [], 'earth', 697, 1340, 715, 1385)
kleshnya = cell('kleshnya', 0, 0, 1, [], 'earth', 862, 1416, 861, 1375)
pidortown = cell('lannisport', 2, 0, 2, [], 'earth', 377, 1282, 360, 1337)
...
uzkoe_more.sosed = [belaya_gavan, white_port, rov_keylin, bliznetsy, persti, drozhashee_more, vdoviy_dozor,
                    orlinoe_gnezdo, lunnie_gori, kleshnya, gubitelnie_vali]
...
gubitelnie_vali.sosed = [uzkoe_more, dragonstone, chernovod_zaliv, east_summer_more, kleshnya, king_les, storm_predel,
                         storm_port, dragonstone_port]
...
primorskie_marki.sosed = [zakatnoe_more, gold_proliv, west_summer_more, higarden, prostor, chernovodnaya,
                          kamennaya_septa, pidortown]
...
east_summer_more.sosed = [west_summer_more, starfall, soleniy_bereg, sun_kopyo, sun_port, dorn_more, gubitelnie_vali,
                          storm_predel]
...
west_summer_more.sosed = [arbor, proliv_redvin, zakatnoe_more, east_summer_more, starfall, three_bashni, higarden,
                          primorskie_marki]
...
all_territories_iporting = [winterfall, rov_keylin, cherniy_zamok, belaya_gavan, drozhashee_more, winterfall_port,
                   ...
                   dragonstone_port, king_les, primorskie_marki, prostor, storm_predel, storm_port, higarden,
                   dorn_marks,
                   kostanoy_put, prince_pereval, ayronvud, sun_kopyo, sun_port, dorn_more, east_summer_more,
                   soleniy_bereg, starfall, arbor, proliv_redvin, west_summer_more, three_bashni, staromest,
                   staromest_port]

def import_cells():
    return all_territories_iporting
